...
image:https://img.shields.io/:license-apache-blue.svg["License", link="https://www.apache.org/licenses/LICENSE-2.0.html"]

Additional validator implementations for https://beanvalidation.org/[javax.validation].
...
Most validators use https://commons.apache.org/lang[Apache Commons Lang3] and https://commons.apache.org/validator[Apache Commons Validator] functionality to implement various validation routines.
