...
public final class ExistingTest {
    ...
    @Test
    public void shouldValidateStringRepresentingExistingDirectory() throws Exception {
    ...
    @Test
    public void shouldNotValidateNonExistingPath() throws Exception {
